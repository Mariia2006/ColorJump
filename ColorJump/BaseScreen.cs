...
namespace ColorJump
{
    public abstract class BaseScreen : Form // успадкування від форми 
    {
        ...
        protected BaseScreen(bool suppressKeyEvents, bool gameMusic, bool isMute)
        {
            muted = isMute;
            ...
            KeyDown += BaseScreen_KeyDown; // обробник натискання клавіш
            KeyUp += BaseScreen_KeyUp; // обробник відпускання клавіш
        ...
        private void BaseScreen_KeyDown(object sender, KeyEventArgs e)
        {
            key = e.KeyValue; // зберігаємо код натиснутої клавіші
            Input(key); // викликаємо метод обробки клавіш
        }

        private void BaseScreen_KeyUp(object sender, KeyEventArgs e)
        {
